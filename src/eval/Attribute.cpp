...
AttributeMap AttributeMap::makeDefault() {
	AttributeStorage attributeStorage = boost::assign::map_list_of
		...
		(ids::Plus, AttributeSet({ids::Flat, ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::OneIdentity, ids::Orderless, ids::Protected}))
		(ids::Times, AttributeSet({ids::Flat, ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::OneIdentity, ids::Orderless, ids::Protected}))
		(ids::Power, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::OneIdentity, ids::Protected}))
		(ids::Abs, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Divide, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Numerator, AttributeSet({ids::Listable, ids::ThreadSafe, ids::Protected}))
		(ids::Denominator, AttributeSet({ids::Listable, ids::ThreadSafe, ids::Protected}))
		...
		(ids::DirectedInfinity, AttributeSet({ids::Listable, ids::ThreadSafe, ids::Protected, ids::ReadProtected}))
		...
		(ids::Minus, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Subtract, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Apply, AttributeSet({ids::Protected}))
		(ids::Sin, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Cos, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Tan, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Cot, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Csc, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Sec, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::ArcSin, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::ArcCos, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::ArcTan, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::ArcCot, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::ArcCsc, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::ArcSec, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected, ids::ReadProtected}))
		(ids::Factorial, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Factorial2, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Sqrt, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		...
		(ids::Floor, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		(ids::Ceiling, AttributeSet({ids::Listable, ids::ThreadSafe, ids::NumericFunction, ids::Protected}))
		...
		(ids::Range, AttributeSet({ids::Listable, ids::ThreadSafe, ids::Protected}))
		...
		(ids::In, AttributeSet({ids::Protected, ids::Listable}))
