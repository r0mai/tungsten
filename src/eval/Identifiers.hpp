...
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(Re);
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(Im);
...
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(AllTrue);
...
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(Out);
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(In);
...
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(ContinuedFraction);
TUNGSTEN_DEFINE_CONSTANT_IDENTIFIER(FromContinuedFraction);
...
TUNGSTEN_DEFINE_CONSTANT_ATTRIBUTE(ThreadSafe);
